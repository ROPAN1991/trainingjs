...
// ------------------------------------Методи push(), pop(), shift(), unshift()--змінюють оригінал------------------------------------------
...
// ----------------------------------------Метод slice()-------робить копію вихідного масиву--------------------------------
...
// --------------------------------------------Метод concat()------------робить копію вихідного масиву----------------------------
...
// квадратні дужки використовуються для масиву [1,2,3] і в доступі до ключа об'єктів const bookAuthor = book[propKey], доступ до елемента масиву по індексу - "масив[0]", деструктуризація;.